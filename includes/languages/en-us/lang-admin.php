...
return [
    ...
    "fmg_browse_edit_related_upload" => "The FileMaker API can't upload files to container fields in related tables",
    "fmg_browse_edit_disabled" => "This field can't be modified manually",
    "fmg_browse_edit_success" => "The field has been updated!",
    "fmg_browse_edit_fail" => "Failed to update the field",

    "fmg_browse_edit_file_empty" => "This container field is empty",
    "fmg_browse_edit_file_contain" => "This field contains a file",
    "fmg_browse_download_wait" => "Generating the file....",
    "fmg_browse_download_success" => "Download...",
    "fmg_browse_download_fail" => "Failed to download",
